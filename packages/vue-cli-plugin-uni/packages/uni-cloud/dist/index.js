...
const IS_UNI_APP = "uni" === 'uni';
const IS_UNI_APP_SSR = "uni" === 'uni-vue3-cjs';
const IS_VUE3 = "uni" === 'uni-vue3-es';
const IS_VUE2 = "uni" === 'uni';

const IS_DEV = process.env.NODE_ENV === 'development';
const UNI_PLATFORM = (process.env.VUE_APP_PLATFORM );
...
function getSafeProxy (target, handler) {
  ...
  {
    target.__ob__ = undefined; // for vue2
  }
